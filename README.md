...
- `npm test` validates catalog IDs, adapter coverage, source-line semantics, and layout fixtures.
...
- `src/viewer/` contains the production workbench and its imperative interaction controller.
